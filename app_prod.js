...
bayc_bc_api.setBchainUtils(configGlobal);
...
//let sslpass = Buffer.from(fs.readFileSync(configGlobal.encryption.pathToPassKeySSL).toString('utf8'), 'base64').toString();
https.createServer({
    //key: fs.readFileSync('./key.pem'),
    //cert: fs.readFileSync('./cert.pem'),
    //key: fs.readFileSync(configGlobal.encryption.pathToPrivateKeySSL),
    //cert: fs.readFileSync(configGlobal.encryption.pathToPublicKeySSL),
    //passphrase: sslpass,//fs.readFileSync(configGlobal.encryption.pathToPassKeySSL).toString('utf8'),//configGlobal.encryption.passKeySSL,
    //minVersion: 'TLSv1.2',
